swApp.controller('showBioCtrl', ['$scope', '$routeParams', '$http', function ($scope, $routeParams, $http) {
 	$scope.model = {
    	item: $routeParams.item   
 	}; 
 	$scope.item = $routeParams.item;
 	url = 'http://ws.audioscrobbler.com/2.0/?method=artist.getinfo&artist=' + $scope.item + '&api_key=a1b827bb5962ea81025679fd8869f5ed&format=json';
  $http.get (url)
